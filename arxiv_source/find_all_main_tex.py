...
if __name__ == "__main__":
    # 输入根目录路径
    root_directory = "/cpfs01/shared/llm_dev/liuwenran/arxiv/arxiv_source_uncompressed_total/cs.AI"

    # 输出文件路径（可选）
    output_file_path = "data_info/directories_with_main_tex.txt"

    # 查找并保存包含 main.tex 的子目录
    result = find_direct_subdirectories_with_main_tex(root_directory, output_file=output_file_path)
